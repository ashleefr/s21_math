[EN | [RU](https://github.com/ashleefr/s21_math/blob/main/README_RU.md)]

# Own implementation of the library "math.h"

The project is the task of the School 21
...
`make` - creating a static library s21_math.a

`make test` - Unit-tests

`make gcov_report` - creating an html page with Unit-test coverage analysis

`make work` - creating an executable file s21_work_main.out, where you can check the program's operation with your own input data
